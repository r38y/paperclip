  ...
  class Attachment
    ...
    def assign uploaded_file
      ...
      begin
        ...
        log("Couldn't get dimensions for #{name}")
      end if image?
    ...
    def instance_write(attr, value, optional=false)
      ...
      instance.send(setter, value) if !optional || responds || attr.to_s == "file_name"
    end
    ...
    def instance_read(attr, optional=false)
      ...
      instance.send(getter) if !optional || responds || attr.to_s == "file_name"
    end
